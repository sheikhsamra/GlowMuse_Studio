...
const handFeetServices = [
  {
    title: "Nail Art",
    price: "Rs. 1,500",
    desc: "Creative and trendy nail designs for any occasion.",
    img: nails,
  },
  {
    title: "Manicure",
    price: "Rs. 1,000",
    desc: "Professional manicure to keep your hands soft and nails flawless.",
    img: manicure,
  },
  {
    title: "Pedicure",
    price: "Rs. 1,200",
    desc: "Relaxing pedicure for smooth and beautiful feet.",
    img: pedicure,
  },
];

const HandFeetSection = ({ searchTerm }) => {
  const cardsRef = useRef([]);

  // Filter services based on searchTerm
  const filteredHandFeet = handFeetServices.filter(
    (item) =>
  ...
  return (
    <section id="handfeet" className="py-16 bg-[#703d02]">
      {/* Heading */}
